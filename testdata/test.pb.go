...
const (
	...
	SomeEnum_SOME_ENUM_VALUE_2 SomeEnum = 3
)
...
type TestMessage struct {
	...
	SomeSint64  int64                   `protobuf:"zigzag64,5,opt,name=some_sint64,json=someSint64,proto3" json:"some_sint64,omitempty"`
	SomeFloat32 float32                 `protobuf:"fixed32,6,opt,name=some_float32,json=someFloat32,proto3" json:"some_float32,omitempty"`
	SomeFloat64 float32                 `protobuf:"fixed32,7,opt,name=some_float64,json=someFloat64,proto3" json:"some_float64,omitempty"`
	SomeBool    bool                    `protobuf:"varint,8,opt,name=some_bool,json=someBool,proto3" json:"some_bool,omitempty"`
	SomeSlice   []string                `protobuf:"bytes,9,rep,name=some_slice,json=someSlice,proto3" json:"some_slice,omitempty"`
	SomeMsg     *ChildMessage           `protobuf:"bytes,10,opt,name=some_msg,json=someMsg,proto3" json:"some_msg,omitempty"`
	SomeMsgs    []*ChildMessage         `protobuf:"bytes,11,rep,name=some_msgs,json=someMsgs,proto3" json:"some_msgs,omitempty"`
	SomeMap     map[int32]*ChildMessage `protobuf:"bytes,12,rep,name=some_map,json=someMap,proto3" json:"some_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	SomeEnum    SomeEnum                `protobuf:"varint,13,opt,name=some_enum,json=someEnum,proto3,enum=testproto.SomeEnum" json:"some_enum,omitempty"`
	SomeEnum2   SomeEnum2               `protobuf:"varint,14,opt,name=some_enum2,json=someEnum2,proto3,enum=testproto.SomeEnum2" json:"some_enum2,omitempty"`
...
type TestMessage_OneOfInt32 struct {
	OneOfInt32 int32 `protobuf:"varint,15,opt,name=one_of_int32,json=oneOfInt32,proto3,oneof"`
}

type TestMessage_OneOfStr struct {
	OneOfStr string `protobuf:"bytes,16,opt,name=one_of_str,json=oneOfStr,proto3,oneof"`
}
...
var file_testdata_test_proto_rawDesc = []byte{
	...
	0x22, 0xe3, 0x05, 0x0a, 0x0b, 0x54, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	,
	...
	,
